...
def cspdarknet53(input_data):
    ...
    input_data = common.convolutional(input_data, (3, 3, 64, 128), downsample=True, activate_type="leaky")
    route = input_data
    ...
    input_data = common.convolutional(input_data, (3, 3, 128, 256), downsample=True, activate_type="leaky")
    route = input_data
